...
public class RepositoryBase<T, K> : IRepositoryBase<T> where T : class where K : class
{
    ...
    public Guid IncluirCliente(Usuario user)
    {
        throw new NotImplementedException();
    }

    public Usuario BuscarCliente(Usuario user)
    {
        throw new NotImplementedException();
    }

    public Usuario AlterarCliente(Usuario user)
    {
        throw new NotImplementedException();
    }

    public bool DeletarCliente(Usuario user)
    {
        throw new NotImplementedException();
    }
}